function lab = segmentGreyHeightMap2D_noFilter( imgMIPZ, imgMIPZH, pixelSize, neighbourhoodRadius, maxRangeZ, removeBorderObjectsInZ, borderZRemoveMethod, thresholdIntensity, minP)
% -----------------------------------------------------------------------
% 
% FUNCTION: segmentHeightMap2D_noFilter
% 
