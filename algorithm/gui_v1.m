...
%
%      GUI_V1('Property','Value',...) creates a new GUI_V1 or raises
...
% Last Modified by GUIDE v2.5 31-Aug-2015 11:19:36
...
function dirSummaryTable_CreateFcn(hObject, eventdata, handles)
% hObject    handle to dirSummaryTable (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
function dirSummaryTable_Callback(hObject, eventdata, handles)
% hObject    handle to dirSummaryTable (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of dirSummaryTable as text
%        str2double(get(hObject,'String')) returns contents of dirSummaryTable as a double
...
% Save the new dirSummaryTable value
...
set(handles.dirSummaryTable, 'String', handles.metricdata.density);
...
% --- Executes on button press in checkboxSummaryTable.
function checkboxSummaryTable_Callback(hObject, eventdata, handles)
% hObject    handle to checkboxSummaryTable (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkboxSummaryTable
